...
export function NotificationItem({ notification, onToggle, onMarkAsRead, expanded }: NotificationItemProps) {
  const getIcon = () => {
  ...
  return (
    <div
      className={cn(
        ...
        notification.status === "unread" ? "bg-blue-50 dark:bg-blue-950" : "bg-white dark:bg-gray-900",
      )}
    >
      <div className="p-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                {notification.status === "unread" && <span className="h-2 w-2 rounded-full bg-blue-500"></span>}
              </div>
            ...
            {!expanded && notification.status === "unread" && (
        ...
        {notification.expandable && expanded && notification.details && (
